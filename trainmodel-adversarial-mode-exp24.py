...
#---------------------------------------------------------------------------------------------------------------------------------
#generator_model = Generator(nstack = 8 , inp_dim = 256 , oup_dim = 16)
...
modelpath_gen = torch.load('mpii-pretrain-high-accuracy/model_100_1300.pt')
generator_model = modelpath_gen['generator_model']

#pretrained Discriminator model#
modelpath_disc = torch.load('mpii-pretrain-posediscriminator-with-badgenerator/model_pretrained_pose_9_10000.pt')
discriminator_model_pose = modelpath_disc['discriminator_model_pose']
...
#
        ...
        loss = cur_gen_loss  + (cur_disc_loss_dic_pose)/220   #alpah value
