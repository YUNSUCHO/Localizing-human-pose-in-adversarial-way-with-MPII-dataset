...
In two different setup, the left side image is the ground-truth images with the key-points and the right side image is the output of the proposed model 
In each images of the result, the red dot stands for the ground-truth co-ordinate joints, yellow dot stands for the prediction of the proposed model. 
